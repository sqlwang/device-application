/**
 * @class ux.WebSocketManager
 * @author Vincenzo Ferrari <wilk3ert@gmail.com>
 * @singleton
 *
 * Manager of ux.WebSocket
 *
 * This singleton provide some useful functions to use for many websockets.
 *
 *     var ws1 = Ext.create ('ux.WebSocket', {
 *       url: 'ws://localhost:8888'
 *     });
 *
 *     ux.WebSocketManager.register (ws1);
 *
 *     var ws2 = Ext.create ('ux.WebSocket', {
 *       url: 'ws://localhost:8900'
 *     });
 *
 *     ux.WebSocketManager.register (ws2);
 *
 *     var ws3 = Ext.create ('ux.WebSocket', {
 *       url: 'ws://localhost:8950'
 *     });
 *
 *     ux.WebSocketManager.register (ws3);
 *
 *     ux.WebSocketManager.listen ('system shutdown', function (ws, data) {
 *       Ext.Msg.show ({
 ...
 *     });
 *
 *     ux.WebSocketManager.broadcast ('system shutdown', 'BROADCAST: the system will shutdown in few minutes.');
 *
 *     ux.WebSocketManager.closeAll ();
 *
 *     ux.WebSocketManager.unregister (ws1);
 *     ux.WebSocketManager.unregister (ws2);
 *     ux.WebSocketManager.unregister (ws3);
 */
Ext.define('ux.WebSocketManager', {
    singleton: true,
    ...
    /**
     * @method register
     * Registers one or more ux.WebSocket
     * @param {ux.WebSocket/ux.WebSocket[]} websockets WebSockets to register. Could be only one.
     */
     ...
     * @param {ux.WebSocket} websocket The WebSocket to find
     ...
     * @return {ux.WebSocket} The websocket or undefined
     */
    get: function (url) {
    ...
    /**
     * @method unregister
     * Unregisters one or more ux.WebSocket
     * @param {ux.WebSocket/ux.WebSocket[]} websockets WebSockets to unregister
     */
     ...
     * @param {ux.WebSocket/ux.WebSocket[]} websockets An array of websockets to take off the communication
     * @param {String} event The event to raise
     ...
     * @param {String/String[]} events Events to listen
     * @param {ux.WebSocket/ux.WebSocket[]} websockets WebSockets to exclude
     * @param {Function} handler The events' handler
     */

 ...
 *
 *     var websocket = Ext.create ('ux.WebSocket', {
...
Ext.define('ux.WebSocket', {
     ...
     * @param {ux.WebSocket} this The websocket
     */
	 ...
	 *     };
     *
     *     var ws = Ext.create ('ux.WebSocket', config);
     *
     *     // or with websocket url only
     *     var ws = Ext.create ('ux.WebSocket', 'ws://localhost:30000');
     *
     * @return {ux.WebSocket} An instance of ux.WebSocket or null if an error occurred.
     */
    constructor: function (cfg) {
        ...
        // e.g.: Ext.create ('ux.WebSocket', 'ws://localhost:8888');
     ...
     * @return {ux.WebSocket} The websocket
     */
    close: function () {
        var me = this;
